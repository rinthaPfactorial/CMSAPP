...
import { TextReveal, Transition } from "@/blocks/ui";
...
const HeaderUi = ({ social, socialLinks }: { social: any, socialLinks: any, }) => {
    const [isActive, setIsActive] = useState(false);
    const isMobile = useMediaQuery("(max-width:768px)");
    console.log("social 4764777", social)
    ...
    return (
        ...
        >
            ...
            >
                <AnimatePresence>
                    {isActive && <Nav navLinks={social.nav} setIsActive={setIsActive} socialLinks={socialLinks} />}
                </AnimatePresence>
            </motion.div>
            <Button
                isActive={isActive}

...
import { SectionHeading, SlideIn, TextReveal, Transition } from "@/blocks/ui";
import { useMediaQuery } from "@/utils/useMediaQuery";
import { Button } from "@/blocks/ui";
import { useCursorVariants } from "@/utils/context";
import { Dialog } from "@/blocks/ui";
import { Work } from "@/payload-types";
import { ProjectsProvider, useProjects } from "@/utils/project-context";
// import ceoimage from '../../public/assets/whoiam.jpg'
    ...
    return (
        <ProjectsProvider data={data}>
            <section className="md:p-8 p-4 relative" id="projects">
                <SectionHeading className="md:pl-14">
                    <SlideIn className="text-paceBlue">Selected</SlideIn>
                    <br />
...
const ProjectContainer = ({ data }: ProjectProps) => {
...
const Card = ({ heading, image, subHeading }: Work) => {
    ...
    return (
        <motion.div
            layout
            className="relative rounded-xl md:rounded-3xl overflow-hidden aspect-square bg-paceBlue md:px-4"
        ...
        >
            ...
            <div className="md:py-8 relative">
                ...
                >
                    <p className="text-sm md:text-xl font-semibold max-md:opacity-0">
                        {heading} {/* Use 'heading' instead of 'title' */}
                    </p>
            ...
            {image && (
                <Image
                    src={image.url} // Use 'image.url' from your response
                    width={500}
                    height={500}
                    alt={image.alt || heading} // Use image alt text or heading
